...
def generate_charts(data, output_dir):
    ...
    if not numeric_data.empty:
        ...
        heatmap_path = os.path.join(output_dir, "correlation_heatmap.png")  # Save directly in the output directory
    ...
    if not numeric_data.empty:
        ...
        boxplot_path = os.path.join(output_dir, "outlier_detection.png")
...
def generate_narrative(analysis, charts, data, output_dir):
...
def main():
    ...
    generate_narrative(analysis, charts, data, output_dir)
